...
namespace Flairphi\LaravelModules;
...
use Flairphi\LaravelModules\Exceptions\InvalidAssetPath;
use Flairphi\LaravelModules\Exceptions\ModuleNotFoundException;
use Flairphi\LaravelModules\Process\Installer;
use Flairphi\LaravelModules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @param $path
     * @return \Flairphi\LaravelModules\Module
     */
     ...
     * @return string
     * @throws \Flairphi\LaravelModules\Exceptions\ModuleNotFoundException
     */
