...
class ModuleGenerator extends Generator
{
    ...
    /**
     * Module type in case of multi tenancy is enabled
     * @var string
     */
    protected  $type = "";
    ...
    /**
     * get module type replacement
     * @return string
     */
    protected function getModuleTypeReplacement(){
        return $this->type;
    }
    /**
    ...
    protected function getRoutesWebLocationReplacement()
    {
        return '/' . $this->module->config('stubs.files.routes/web');
    }

    protected function getRoutesApiLocationReplacement()
    {
        return '/' . $this->module->config('stubs.files.routes/api');
    }
